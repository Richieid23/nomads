                        ...
                        <div class="card card-details">
                            ...
                            <div class="gallery">
                                <div class="xzoom-container">
                                    <img src="{{ url('frontend/images/details-1.jpg') }}" class="xzoom" id="xzoom-default" xoriginal="{{ url('frontend/images/details-1.jpg') }}" alt="">
                                </div>
                                <div class="xzoom-thumbs">
                                    <a href="{{ url('frontend/images/details-1.jpg') }}">
                                        <img src="{{ url('frontend/images/details-1.jpg') }}" class="xzoom-gallery" width="128" xpreview="{{ url('frontend/images/details-1.jpg') }}" alt="">
                                    </a>
                                    <a href="frontend/images/details-1.jpg">
                                        <img src="{{ url('frontend/images/details-1.jpg') }}" class="xzoom-gallery" width="128" xpreview="{{ url('frontend/images/details-1.jpg') }}"
                                            alt="">
                                    </a>
                                    <a href="{{ url('frontend/images/details-1.jpg') }}">
                                        <img src="{{ url('frontend/images/details-1.jpg') }}" class="xzoom-gallery" width="128" xpreview="{{ url('frontend/images/details-1.jpg') }}"
                            ...
                            <div class="features row">
                                <div class="col-md-4">
                                    <img src="{{ url('frontend/images/ic_event.png') }}" alt="" class="features-icon">
                                ...
                                <div class="col-md-4 border-start">
                                    <img src="{{ url('frontend/images/ic_bahasa.png') }}" alt="" class="features-icon">
                                    <div class="description">
                                        <h3>Language</h3>
                                ...
                                <div class="col-md-4 border-start">
                                    <img src="{{ url('frontend/images/ic_foods.png') }}" alt="" class="features-icon">
                                    <div class="description">
                                        <h3>Foods</h3>
                                        <p>Local Foods</p>
                                    </div>
